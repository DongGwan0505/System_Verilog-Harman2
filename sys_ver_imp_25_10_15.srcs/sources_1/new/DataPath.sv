...
module DataPath (
    ...
    logic [31:0] RFData1, RFData2, aluResult;  //R-type
    logic [31:0] PCOutData, PC_4_AdderResult;  //I-type
    logic [31:0] immExt, aluSrcMuxOut, RFWDSrcMuxOut;  //S & L - type
    logic [31:0] JLSrcMuxOut; //JL-type
    logic [31:0] PC_Imm_AdderResult, PCSrcMuxOut; //B-type
    logic        PCSrcMuxSel; //B-type
    logic        btaken; //B-type
