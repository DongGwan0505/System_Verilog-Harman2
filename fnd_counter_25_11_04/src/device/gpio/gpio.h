...
#define GPIOA		((GPIO_TypeDef *)GPIO_0_BASEADDR) //25_11_04 fnd controller
#define GPIOB		((GPIO_TypeDef *)GPIO_1_BASEADDR) //25_11_04 fnd com & led
#define GPIOC		((GPIO_TypeDef *)GPIO_2_BASEADDR) //25_11_04 btn
